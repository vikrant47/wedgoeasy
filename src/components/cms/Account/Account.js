...
import { IoIosCash, IoIosClipboard, IoIosCreate, IoIosDownload, IoIosList, IoIosPerson } from 'react-icons/io';
import Card from 'react-bootstrap/Card';
import Link from 'next/link';
import { FaCloudDownloadAlt, FaRegEdit } from 'react-icons/fa';

const Account = ({ section, page, website }) => (<div className='my-account-content space-pt--r100 space-pb--r100'>
  <Container>
